...
model = dict(
    backbone=dict(img_size=768, align_corners=False,
                  ...
                  model_name='vit_base_patch16_384', embed_dim=768, 
                  depth=12, num_heads=12),
    decode_head=dict(img_size=768, embed_dim=768, align_corners=False, num_conv=2,
                     upsampling_method='bilinear', conv3x3_conv1x1=False, in_index=11),
    auxiliary_head=[dict(
