...
# HLG Transformer parameters
_C.MODEL.HLG = CN()
_C.MODEL.HLG.PATCH_SIZE = 4
_C.MODEL.HLG.IN_CHANS = 3
_C.MODEL.HLG.EMBED_DIMS = [64, 128, 256, 512]
_C.MODEL.HLG.DEPTHS = [2, 2, 6, 2]
_C.MODEL.HLG.NUM_HEADS = [2, 4, 8, 16]
_C.MODEL.HLG.MLP_RATIO = [4, 4, 4, 4]
_C.MODEL.HLG.SR_RATIOS = [8, 4, 2, 1]
_C.MODEL.HLG.QKV_BIAS = True
_C.MODEL.HLG.QK_SCALE = None
_C.MODEL.HLG.H0_H1_METHOD = 'mean'
_C.MODEL.HLG.DPB = True
